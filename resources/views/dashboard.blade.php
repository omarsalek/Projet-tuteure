        ...
        <div id="content" class="content p-0">
            <div class="profile-header">
                ...
                <ul class="profile-header-tab nav nav-tabs">
                    ...
                    <li class="nav-item"><a href="/mesDemandesAcceptees" class="nav-link " data-toggle="tab">Mes Demandes acceptées <span class="badge badge-success">{{$nbAcceptation[0]->nb}}</span> </a></li>
